...
import (
	...
	"github.com/rlawnsxo131/madre-server-v3/internal/engine/httpmiddleware"
	...
	"github.com/rlawnsxo131/madre-server-v3/internal/pkg/auth"
...
func (e *httpEngine) RegisterAPIMiddleware() {
	...
	e.r.Use(httpmiddleware.HTTPLogger)
...
func (e *httpEngine) RegisterAPI() {
	e.r.Route("/api", func(r chi.Router) {
		r.Route("/v1", func(r chi.Router) {
			auth.RegisterHTTPHandler(r, e.db)
			user.RegisterHTTPHandler(r, e.db)
		})
	})
}
